...
const AudioPlayer = ({track}: any) => {
  ...
  return (
    <div className="card fadeIn blurOut p-2 flex border hover:shadow-xl hover:border-orange-600 dark:hover:border-orange-600 dark:border-zinc-900 dark:bg-zinc-900 bg-zinc-300 rounded-md">
      ...
      <div className="h-28 flex items-end ">
        <div className={`card__tags w-max`}>
          {tags.map((tag: string[], id: number) => (
            ...
            <span className="bg-zinc-800 text-white dark:bg-orange-800 dark:hover:bg-orange-600 rounded-md">#{tag}</span>
          </button>
          ))}
